...
For this project, you need to create a new class file for example:  IGT2022\src\main\java\org\powertac\samplebroker\wholesalemarket\Team1.java
The name of your class file should be Team<YOUR_TEAM_NUMBER>.java

For the final submission, you just need to submit Team<YOUR_TEAM_NUMBER>.java file, not the entire project.

Few Additional Comments
=======================

4 baseline wholesale strategies are provided in the project for your reference (IGT2022\src\main\java\org\powertac\samplebroker\wholesalemarket/{ZI, ZIP, Linear, TT}.java). You can use these strategies as reference to design your wholesale strategy. 

Additionally, you can test your strategy against these baseline strategies.If you want to utilize DL/RL in your wholesale strategy, and for that, if you need to collect data; you can make use mongodb code provided in the project (in the commented form, you need to uncomment appropriate code snippets.) Contact me in case you need any help for this task.
