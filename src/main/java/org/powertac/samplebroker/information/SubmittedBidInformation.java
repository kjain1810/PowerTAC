...
public class SubmittedBidInformation
{
  ...
  public void setSubmittedBidInformationbyMessageTimeslot(Integer messageTime, Integer executionTime, List<Double> price, List<Double> quantity)
  {
      ...
      if((price != null) && (quantity != null))
      {
        ...
        for(Double lq: quantity)
          avgQuantity += lq;
      }

      SBMList.add(new Pair<Double, Double>(avgPrice, avgQuantity));
  ...
  public void setSubmittedBidInformationbyExecutionTimeslot(Integer executionTime, Integer messageTime, List<Double> price, List<Double> quantity)
  {
